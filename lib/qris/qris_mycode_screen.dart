...
class _QrisMyCodeScreenState extends State<QrisMyCodeScreen> {
  ...
  static const String _qrData = 'TCPAY://USER/TCPAY-USER-8821';
  static const String _displayBalance = 'Rp 1.234.567';
            ...
            child: Row(
              children: [
                CircleAvatar(
                  ...
                  child: const Text('AD', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
                ),
